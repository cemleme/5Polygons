    ...
    VRFConsumerBaseV2
{
    ...
    uint256 public ticketPerAmount = 0.1 ether;
    ...
    constructor(address vrfCoordinator, bytes32 _keyHash, uint64 _s_subscriptionId)
        ERC1155("https://ipfs.io/ipfs/bafybeify2d6jkpizrcskkmkoyabfrj2anz4frhovgc377x2n4x7nvdkvra/{id}.json")
    ...
    //SETTER FUNCTIONS
        ...
        function getPayout(uint64 result) external pure returns (uint256 resultType) {
            ...
            uint256 polygon1 = (result / 10000) % 5;
            uint256 polygon2 = (result / 1000) % 5;
            uint256 polygon3 = (result / 100) % 5;
            uint256 polygon4 = (result / 10) % 5;
            uint256 polygon5 = result % 5;
    ...
    // OPERATIONAL
            ...
            returns (uint32 result, uint8 resultType)
        {
            ...
            uint256 polygon1 = (random / 10000) % 5;
            uint256 polygon2 = (random / 1000) % 5;
            uint256 polygon3 = (random / 100) % 5;
            uint256 polygon4 = (random / 10) % 5;
            uint256 polygon5 = random % 5;
